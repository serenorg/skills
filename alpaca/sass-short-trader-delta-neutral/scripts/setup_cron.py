#!/usr/bin/env python3
"""
Create/update seren-cron jobs for sass-short-trader-delta-neutral.
"""
...
def build_jobs(runner_url: str, webhook_secret: str, timezone: str, mode: str, learning_mode: str) -> List[Dict[str, Any]]:
    ...
    common = {
        "skill": "sass-short-trader-delta-neutral",
    ...
    return [
        {
            "name": "sass-short-trader-delta-neutral-scan",
            "schedule": "15 8 * * 1-5",
            "timezone": timezone,
            "url": run_url,
            "method": "POST",
        ...
        {
            "name": "sass-short-trader-delta-neutral-monitor",
        ...
        {
            "name": "sass-short-trader-delta-neutral-post-close",
            "schedule": "20 16 * * 1-5",
            "timezone": timezone,
            "url": run_url,
            "method": "POST",
        ...
        {
            "name": "sass-short-trader-delta-neutral-label-update",
            "schedule": "35 16 * * 1-5",
            "timezone": timezone,
            "url": run_url,
            "method": "POST",
        ...
        {
            "name": "sass-short-trader-delta-neutral-retrain",
            "schedule": "30 9 * * 6",
            "timezone": timezone,
            "url": run_url,
            "method": "POST",
        ...
        {
            "name": "sass-short-trader-delta-neutral-promotion-check",
            "schedule": "0 7 * * 1",
            "timezone": timezone,
            "url": run_url,
            "method": "POST",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Setup seren-cron jobs for sass-short-trader-delta-neutral")
...
def main() -> None:
    ...
    if not args.dry_run:
        ...
        jobs = [j for j in setup.extract_jobs(listed) if str(j.get("name", "")).startswith("sass-short-trader-delta-neutral-")]
