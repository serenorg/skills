#!/usr/bin/env python3
"""
Self-learning runner for sass-short-trader-delta-neutral.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Self-learning runner for sass-short-trader-delta-neutral")
